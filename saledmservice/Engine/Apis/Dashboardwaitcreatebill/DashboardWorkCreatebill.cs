...
namespace saledmservice.Engine.Apis.DashboardWorkCreatebill
{
    public class DashboardWorkCreatebill : Base<dashboardWorkpayReq>
    {
        protected override void ExecuteChild(dashboardWorkpayReq dataReq, ResponseAPI dataRes)
        {
            ...
            var roles = Ado.Mssql.View.dashboardWorkpay.GetInstant().Search(dataReq);
